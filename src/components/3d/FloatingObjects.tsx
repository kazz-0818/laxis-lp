    ...
    <group ref={group}>
      ...
      <Float speed={1.3} floatIntensity={1.2}>
        <RoundedBox args={[2.2 * s, 1.3 * s, 0.1]} radius={0.08} position={[-2.4, 0.4, 0]}>
          <meshStandardMaterial color="#1e4d7a" metalness={0.55} roughness={0.25} />
        </RoundedBox>
      </Float>

      <Float speed={1.5} floatIntensity={1.3}>
        <RoundedBox args={[1.2 * s, 1.2 * s, 0.1]} radius={0.06} position={[2.2, 0, 0.4]}>
          <meshStandardMaterial color="#2dd4bf" emissive="#2dd4bf" emissiveIntensity={0.2} metalness={0.4} />
        </RoundedBox>
      </Float>
      ...
      <Float speed={1.1} floatIntensity={1}>
        <mesh position={[0.3, 1.8 * s, -0.2]}>
          ...
          <meshStandardMaterial color="#22d3ee" wireframe opacity={0.85} transparent />
        </mesh>
      </Float>
      ...
      <Float speed={1.4} floatIntensity={1.1}>
        <mesh position={[2.5, 1.2, -0.5]}>
          ...
          <MeshDistortMaterial color="#06b6d4" distort={0.35} speed={2} metalness={0.5} emissive="#06b6d4" emissiveIntensity={0.15} />
        </mesh>
      </Float>
      ...
      <mesh position={[0, 0, -0.6]}>
        ...
        <meshStandardMaterial color="#5eead4" transparent opacity={0.35} emissive="#5eead4" emissiveIntensity={0.15} />
      </mesh>
    </group>
  )
}
